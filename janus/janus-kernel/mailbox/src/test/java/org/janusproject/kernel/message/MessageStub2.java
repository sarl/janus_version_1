 ...
 */
public class MessageStub2 extends AbstractContentMessage<Object> {
	 ...
	 * @param name
	 */
	public MessageStub2(float date, String name) {
	 ...
	 * @param emitter
	 */
	public MessageStub2(float date, String name, Address emitter) {
		this.creationDate = date;
		this.name = name;
		this.sender = emitter;
	}
