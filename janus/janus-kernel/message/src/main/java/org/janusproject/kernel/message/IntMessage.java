...
/** A message that embbeds a integer value.
 * 
 ...
 */
public class IntMessage extends AbstractContentMessage<Integer> {
	
	private static final long serialVersionUID = 3083436023958726526L;
