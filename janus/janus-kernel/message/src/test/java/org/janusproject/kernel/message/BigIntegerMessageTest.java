 ...
 */
public class BigIntegerMessageTest extends TestCase {

	private BigInteger expected;
	private BigIntegerMessage message;
	...
	public void setUp() throws Exception {
		...
		this.expected = new BigInteger("123"); //$NON-NLS-1$
		this.message = new BigIntegerMessage(this.expected);
	}
