 ...
 */
public class DoubleMessageTest extends TestCase {

	private double expected;
	private DoubleMessage message;
	...
	public void setUp() throws Exception {
		...
		this.expected = 123.456;
		this.message = new DoubleMessage(this.expected);
	}
	...
	public void testGetContent() {
		assertEquals(Double.valueOf(this.expected), this.message.getContent());
	}
