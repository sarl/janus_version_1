 ...
 */
public class JxtaJxseKernelAgent extends KernelAgent implements RepositoryChangeListener, NetworkListener {
	...
	private class GroupCleaner implements Runnable {
		...
		public void run() {
			JxtaJxseKernelAgent.this.removeInactivePersistentGroups(
