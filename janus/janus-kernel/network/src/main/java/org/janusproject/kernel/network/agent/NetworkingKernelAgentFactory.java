...
import org.janusproject.kernel.network.jxta.impl.DefaultJxtaNetworkAdapter;
 ...
 */
public class NetworkingKernelAgentFactory implements KernelAgentFactory {
	...
	public KernelAgent newInstance(Boolean commitSuicide, AgentActivator activator, EventListener startUpListener, String applicationName) throws Exception {
		return new NetworkingKernelAgent(
