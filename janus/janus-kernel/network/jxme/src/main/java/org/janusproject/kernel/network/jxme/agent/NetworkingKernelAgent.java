 ...
 * @deprecated see {@link JxtaJxmeKernelAgent}
 */
@Deprecated
public class NetworkingKernelAgent extends JxtaJxmeKernelAgent {

	private static final long serialVersionUID = 5956672830048918739L;

	/**
	 */
	public NetworkingKernelAgent() {
