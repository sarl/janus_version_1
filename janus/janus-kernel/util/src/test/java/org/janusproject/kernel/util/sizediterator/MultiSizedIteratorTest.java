 ...
 */
public class MultiSizedIteratorTest extends TestCase {

	private Collection<DataStub> collection1, collection2;
	private MultiSizedIterator<DataStub> iterator;
