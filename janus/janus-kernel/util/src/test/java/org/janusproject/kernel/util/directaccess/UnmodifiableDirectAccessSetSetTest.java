 ...
 */
public class UnmodifiableDirectAccessSetSetTest extends TestCase {

	private SortedSet<Integer> original1;
	private SortedSet<Integer> original2;
	private UnmodifiableDirectAccessSetSet<Integer> set;
	...
	public void setUp() throws Exception {
		...
		this.original1 = new TreeSet<>();
		this.original2 = new TreeSet<>();
		this.m1 = 1;
		this.m2 = 10;
		this.m3 = 5;
		this.m4 = 42;
		...
		this.set = new UnmodifiableDirectAccessSetSet<>(this.original1, this.original2);
	}
