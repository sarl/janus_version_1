 ...
 */
public class UnmodifiableDirectAccessCollectionTest extends TestCase {
	...
	public void testGetInt() {
		...
		assertEquals(this.m2, this.collection.get(1));
		assertEquals(this.m3, this.collection.get(2));
    ...
    public void testToArray() {
    	...
    	assertEquals(this.m2, tab[1]);
    	assertEquals(this.m3, tab[2]);
