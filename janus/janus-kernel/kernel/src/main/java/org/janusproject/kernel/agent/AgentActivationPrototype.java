...
/** Annotation that permits to mark agent classes
 ...
 * <pre><code><span>@</span>AgentActivationPrototype(
 ...
 * <pre><code><span>@</span>AgentActivationPrototype
 *<span>@</span>AgentActivationPrototype(
 *   fixedParameters={}
 *)</code></pre>
 * 
...
public @interface AgentActivationPrototype {
	 ...
	 */
	Class<?> variableParameters() default AgentActivationPrototype.class;
	 ...
	 */
	Class<?>[] fixedParameters() default {AgentActivationPrototype.class};
