...
/**
 * This class provides a tuned formatter for log records from agents.
 * <p>
 ...
 */
public class JanusAgentFormatter
extends AbstractJanusFormatter {
	 ...
	 */
	public JanusAgentFormatter(KernelTimeManager timeManager, Address agent) {
		super(timeManager);
		assert(agent!=null);
		this.agent = agent;
	}
	...
	public String getLocalizedMessage(LogRecord record, String message) {
		...
		return Locale.getString(JanusAgentFormatter.class,
