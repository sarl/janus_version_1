...
/**
 * {@link TreeMap}-based implementation of a CapacityContainer.
 *
 * @author $Author: ngaud$
 ...
 * @see Capacity
 */
public class TreeCapacityContainer
extends AbstractCapacityContainer {
	...
	/**
	 * @param comparator is the comparator to sort the internal tree.
	 */
