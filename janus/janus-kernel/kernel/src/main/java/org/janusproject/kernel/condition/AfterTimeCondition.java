 ...
 * @since 0.5
 */
public class AfterTimeCondition extends AbstractCondition<TimeConditionParameterProvider> implements TimeCondition, ConditionFailure {
	
	private static final long serialVersionUID = -9005234706842916331L;
