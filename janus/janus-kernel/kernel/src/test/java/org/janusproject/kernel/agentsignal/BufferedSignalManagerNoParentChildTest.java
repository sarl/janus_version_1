 ...
 */
public class BufferedSignalManagerNoParentChildTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		this.adapter = new BufferedSignalManager(null);
	...
	public void testGetSignal() {
		...
		this.adapter.onSignal(s2 = new Signal(this));
		assertSame(s, this.adapter.getSignal());
		assertSame(s2, this.adapter.getSignal());
		assertNull(this.adapter.getSignal());
	}
