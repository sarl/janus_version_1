 ...
 * @see TreeSetMailbox
 */
public class TreeSetMailboxTest extends TestCase {

	private TreeSetMailbox mailbox;
	...
	public void setUp() throws Exception {
		...
		this.mailbox = new TreeSetMailbox();
	...
	public void testAddMail() {
		...
		if (m7.getIdentifier().compareTo(m6.getIdentifier())<0) {
			MessageStub s = m6;
			m6 = m7;
			m7 = s;
		}
