 ...
 */
public class OrderEnabledAsynchronousThreadSafeCollectionTest extends TestCase {

	private AsynchronousThreadSafeCollection<DataStub> collection;
	private DataStub m1, m2;
	private Comparator<DataStub> comparator;
	...
	public void testIsEmpty() {
		...
		assertFalse(this.collection.applyChanges(false));
	...
	public void testRemove() {
		...
		assertFalse(this.collection.remove(nd3));
