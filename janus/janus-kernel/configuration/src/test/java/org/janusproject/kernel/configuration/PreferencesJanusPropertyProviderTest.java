 ...
 */
public class PreferencesJanusPropertyProviderTest extends TestCase {

	private Preferences prefs;
	private PreferencesJanusPropertyProvider provider;
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.prefs = Preferences.userNodeForPackage(PreferencesJanusPropertyProviderTest.class);
		this.provider = new PreferencesJanusPropertyProvider(this.prefs);
		this.prefs.put("A", "aaa"); //$NON-NLS-1$ //$NON-NLS-2$
		this.prefs.put("B", "bbb"); //$NON-NLS-1$ //$NON-NLS-2$
		this.prefs.put("C", "ccc"); //$NON-NLS-1$ //$NON-NLS-2$
	}
