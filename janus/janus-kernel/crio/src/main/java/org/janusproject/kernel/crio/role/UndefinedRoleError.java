 ...
 */
public class UndefinedRoleError extends Error {

	private static final long serialVersionUID = -4532328473025797487L;
	...
	public UndefinedRoleError(Class<?> organization, Class<?> role) {
		super( Locale.getString(UndefinedRoleError.class,
