 ...
 * @since 0.5
 */
public class CRIOMessageReceivingBench extends CsvBench<AgentNumberBenchRun> {
	 ...
	 * @throws IOException
	 */
	public CRIOMessageReceivingBench(File directory) throws IOException {
		super(directory);
	}
	...
	public void setUpUnitaryBench(AgentNumberBenchRun run) throws Exception {
		...
		for(int i=0; i<run.getNumberOfAgents()-2; ++i) {
			kernel.launchLightAgent(new IddleAgent(null, BenchOrganization.class, false));
		}
	...
	private static class Receiver extends Agent {
		...
		public Status activate(Object... parameters) {
			...
			requestRole(ReceiverRole.class, this.group);
