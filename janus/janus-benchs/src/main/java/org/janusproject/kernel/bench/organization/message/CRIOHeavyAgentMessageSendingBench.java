 ...
 * @since 0.5
 */
public class CRIOHeavyAgentMessageSendingBench extends AbstractCRIOAgentMessageSendingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public CRIOHeavyAgentMessageSendingBench(File directory) throws IOException {
		super(directory);
	}
