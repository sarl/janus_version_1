 ...
 * @since 0.5
 */
public class HeavyAgentSignalSendingBench extends AbstractAgentSignalSendingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public HeavyAgentSignalSendingBench(File directory) throws IOException {
		super(directory);
	}
	...
	protected void launchEmitter(Kernel kernel, Agent agent, int nbListeners) {
		kernel.launchHeavyAgent(agent, nbListeners);
	}
