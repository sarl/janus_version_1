 ...
 * @since 0.5
 */
public class LightAgentSignalSendingBench extends AbstractAgentSignalSendingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public LightAgentSignalSendingBench(File directory) throws IOException {
		super(directory);
	}
	...
	protected void launchEmitter(Kernel kernel, Agent agent, int nbListeners) {
		kernel.launchLightAgent(agent, nbListeners);
	}
