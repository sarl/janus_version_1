 ...
 * @since 0.5
 */
public class LightAgentRoleExecution2Bench extends AbstractRoleExecution2Bench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public LightAgentRoleExecution2Bench(File directory) throws IOException {
		super(directory);
	}
	 ...
	 */
	@Override
	protected void launchRefereeAgent(Kernel kernel, Agent agent, int nbGroups) {
