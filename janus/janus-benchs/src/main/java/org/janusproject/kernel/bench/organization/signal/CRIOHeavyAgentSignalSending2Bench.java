 ...
 * @since 0.5
 */
public class CRIOHeavyAgentSignalSending2Bench extends AbstractCRIOAgentSignalSending2Bench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public CRIOHeavyAgentSignalSending2Bench(File directory) throws IOException {
		super(directory);
	}
