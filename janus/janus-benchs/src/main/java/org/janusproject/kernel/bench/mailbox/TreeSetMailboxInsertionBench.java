 ...
 * @since 0.5
 */
public class TreeSetMailboxInsertionBench extends AbstractMailboxInsertionBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public TreeSetMailboxInsertionBench(File directory) throws IOException {
		super(directory);
	}
	...
	protected Mailbox createMailbox(Comparator<? super Message> comparator) {
		return new TreeSetMailbox(comparator);
	}
