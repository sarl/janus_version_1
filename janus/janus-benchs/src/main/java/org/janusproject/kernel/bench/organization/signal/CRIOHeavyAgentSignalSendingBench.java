 ...
 * @since 0.5
 */
public class CRIOHeavyAgentSignalSendingBench extends AbstractCRIOAgentSignalSendingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public CRIOHeavyAgentSignalSendingBench(File directory) throws IOException {
		super(directory);
	}
