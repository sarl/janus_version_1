 ...
 * @since 0.5
 */
public class IddleAgent extends Agent {

	private static final long serialVersionUID = 8804935270327139156L;

	private final boolean sendingBenchmarks;
	 ...
	 * @param flag
	 * @param organization
	 * @param sendingBenchmark
	 */
	public IddleAgent(AtomicInteger flag, Class<? extends Organization> organization, boolean sendingBenchmark) {
		this.organization = organization;
		this.flag = flag;
		this.sendingBenchmarks = sendingBenchmark;
	}
	...
	public Status activate(Object... parameters) {
		...
		requestRole(IddleRole.class, group, this.sendingBenchmarks);
		return s;
	}
