 ...
 * @since 0.5
 */
public class LightAgentDestructionBench extends CsvBench<AgentNumberBenchRun> {
	 ...
	 * @throws IOException
	 */
	public LightAgentDestructionBench(File directory) throws IOException {
		super(directory);
	}
	...
	public void setUpUnitaryBench(AgentNumberBenchRun run) throws Exception {
		...
		for(int i=0; i<getCurrentRun().getNumberOfAgents()-1; ++i) {
			kernel.submitLightAgent(new IddleAgent(launchedAgents));
		}
