 ...
 * @since 0.5
 */
public class LightAgentMessageReceivingBench extends AbstractAgentMessageReceivingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public LightAgentMessageReceivingBench(File directory) throws IOException {
		super(directory);
	}
