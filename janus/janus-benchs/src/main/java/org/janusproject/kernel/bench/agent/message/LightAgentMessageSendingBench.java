 ...
 * @since 0.5
 */
public class LightAgentMessageSendingBench extends AbstractAgentMessageSendingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public LightAgentMessageSendingBench(File directory) throws IOException {
		super(directory);
	}
