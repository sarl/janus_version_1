 ...
 * @since 0.5
 */
public class HeavyAgentMessageReceivingBench extends AbstractAgentMessageReceivingBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public HeavyAgentMessageReceivingBench(File directory) throws IOException {
		super(directory);
	}
