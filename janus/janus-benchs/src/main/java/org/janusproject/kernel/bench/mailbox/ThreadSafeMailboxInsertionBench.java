 ...
 * @since 0.5
 */
public class ThreadSafeMailboxInsertionBench extends AbstractMailboxInsertionBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public ThreadSafeMailboxInsertionBench(File directory) throws IOException {
		super(directory);
	}
	...
	protected Mailbox createMailbox(Comparator<? super Message> comparator) {
		return new ThreadSafeMailbox(comparator);
	}
