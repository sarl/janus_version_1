 ...
 * @since 0.5
 */
public class CRIOHeavyAgentSignalSending3Bench extends AbstractCRIOAgentSignalSending3Bench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public CRIOHeavyAgentSignalSending3Bench(File directory) throws IOException {
		super(directory);
	}
