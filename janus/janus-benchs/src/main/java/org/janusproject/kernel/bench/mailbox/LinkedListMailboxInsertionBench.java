 ...
 * @since 0.5
 */
public class LinkedListMailboxInsertionBench extends AbstractMailboxInsertionBench {

	/**
	 * @param directory
	 * @throws IOException
	 */
	public LinkedListMailboxInsertionBench(File directory) throws IOException {
		super(directory);
	}
	...
	protected Mailbox createMailbox(Comparator<? super Message> comparator) {
		return new LinkedListMailbox(comparator);
	}
