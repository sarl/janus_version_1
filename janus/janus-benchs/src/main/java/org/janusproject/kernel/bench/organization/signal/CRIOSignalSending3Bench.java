 ...
 * @since 0.5
 */
public class CRIOSignalSending3Bench extends CsvBench<AgentNumberBenchRun> {
	 ...
	 * @throws IOException
	 */
	public CRIOSignalSending3Bench(File directory) throws IOException {
		super(directory);
	}
	...
	private static class Emitter extends Agent {
		...
		public Status activate(Object... parameters) {
			...
			requestRole(EmitterRole.class, this.group, (nb-nb/2));
