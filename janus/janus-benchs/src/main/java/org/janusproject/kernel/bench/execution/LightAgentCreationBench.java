 ...
 * @since 0.5
 */
public class LightAgentCreationBench extends CsvBench<AgentNumberBenchRun> {
	 ...
	 * @throws IOException
	 */
	public LightAgentCreationBench(File directory) throws IOException {
		super(directory);
	}
	...
	public void setUpUnitaryBench(AgentNumberBenchRun run) throws Exception {
		...
		for(int i=0; i<getCurrentRun().getNumberOfAgents()-1; ++i) {
			this.kernel.submitLightAgent(new IddleAgent(launchedAgents));
		}
