 ...
 * @since 0.5
 */
public class CRIOSignalSendingBench extends CsvBench<AgentNumberBenchRun> {
	 ...
	 * @throws IOException
	 */
	public CRIOSignalSendingBench(File directory) throws IOException {
		super(directory);
	}
	...
	private static class Emitter extends Agent {
		...
		public Status activate(Object... parameters) {
			...
			requestRole(EmitterRole.class, this.group, parameters[0]);
