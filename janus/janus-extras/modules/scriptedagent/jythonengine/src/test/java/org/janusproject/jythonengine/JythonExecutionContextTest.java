 ...
 */
public class JythonExecutionContextTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.additionScript = Resources.getResource(JythonExecutionContext.class, ADDITION_SCRIPT_NAME);
		this.scriptDirectory = FileSystem.convertURLToFile(this.additionScript).getParentFile();
		this.interpreter = new JythonExecutionContext(new ScriptEngineManager());
