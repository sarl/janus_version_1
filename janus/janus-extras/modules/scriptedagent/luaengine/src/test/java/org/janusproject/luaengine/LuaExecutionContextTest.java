 ...
 */
public class LuaExecutionContextTest extends TestCase {

	private static final String ADDITION_SCRIPT_NAME = "addition.lua"; //$NON-NLS-1$
	private static final String INTERPRETED_ADDITION_SCRIPT_NAME = "interpretedaddition.lua"; //$NON-NLS-1$
	private static final String HELLO_WORLD_SCRIPT_NAME = "HelloWorld.lua"; //$NON-NLS-1$
	private static final String MY_PRINT_SCRIPT_NAME = "Print.lua"; //$NON-NLS-1$
	private static final String METHOD_SCRIPT_NAME = "Method.lua"; //$NON-NLS-1$
	
	private LuaExecutionContext interpreter;
	...
	protected void setUp() throws Exception {
		...
		this.additionScript = Resources.getResource(LuaExecutionContext.class, ADDITION_SCRIPT_NAME);
		this.scriptDirectory = FileSystem.convertURLToFile(this.additionScript).getParentFile();
		this.interpreter = new LuaExecutionContext(new ScriptEngineManager());
