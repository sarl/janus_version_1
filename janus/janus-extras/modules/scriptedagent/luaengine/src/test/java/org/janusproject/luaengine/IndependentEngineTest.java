...
public class IndependentEngineTest extends TestCase {
	...
	private LuaExecutionContext context1;
	private LuaExecutionContext context2;
	...
	protected void setUp() throws Exception {
		...
		this.context1 = new LuaExecutionContext(this.scriptManager);
		this.context2 = new LuaExecutionContext(this.scriptManager);
	}
