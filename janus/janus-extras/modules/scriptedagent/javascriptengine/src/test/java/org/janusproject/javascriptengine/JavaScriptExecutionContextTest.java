...
public class JavaScriptExecutionContextTest extends TestCase {
	...
	private static final String HELLO_WORLD_SCRIPT_NAME = "HelloWorld.js"; //$NON-NLS-1$
	...
	public void testMakeFunctionCall() throws Exception {
		...
		assertEquals("myFunc(" + //$NON-NLS-1$
				JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"0," + //$NON-NLS-1$
				JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"1," + //$NON-NLS-1$
				JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"2)", //$NON-NLS-1$
				this.interpreter.makeFunctionCall("myFunc", 1, 3, "abc")); //$NON-NLS-1$ //$NON-NLS-2$
		assertEquals(1,
				this.interpreter.getScriptEngine().getContext().getAttribute(JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"0")); //$NON-NLS-1$
		assertEquals(3,
				this.interpreter.getScriptEngine().getContext().getAttribute(JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"1")); //$NON-NLS-1$
		assertEquals("abc", //$NON-NLS-1$
				this.interpreter.getScriptEngine().getContext().getAttribute(JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"2")); //$NON-NLS-1$

		assertEquals("myFunc(" + //$NON-NLS-1$
				JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"3," + //$NON-NLS-1$
				JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"4)", //$NON-NLS-1$
				this.interpreter.makeFunctionCall("myFunc", 1.5d, new BigDecimal(2))); //$NON-NLS-1$
		assertEquals(1.5d,
				this.interpreter.getScriptEngine().getContext().getAttribute(JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"3")); //$NON-NLS-1$
		assertEquals(new BigDecimal(2),
				this.interpreter.getScriptEngine().getContext().getAttribute(JavaScriptExecutionContext.TEMP_VARIABLE_PREFIX+"4")); //$NON-NLS-1$
	}
	...
	public void testRunFunctionFileStringObjectArray() throws Exception {
		...
		assertNotNull(v);
		assertTrue(v instanceof Double);
		assertTrue(Double.isNaN(((Double)v).doubleValue()));
		assertEquals("", output.toString()); //$NON-NLS-1$
		this.listener.assertFalse();
