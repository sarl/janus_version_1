...
public class IndependentEngineTest extends TestCase {
	...
	private LispExecutionContext context1;
	private LispExecutionContext context2;
	...
	protected void setUp() throws Exception {
		...
		this.context1 = new LispExecutionContext(this.scriptManager);
		this.context2 = new LispExecutionContext(this.scriptManager);
	}
	...
	public void testGlobalIndependancy() throws Exception {
		this.context1.runCommand("(setf a 18)"); //$NON-NLS-1$
		this.context2.runCommand("(setf a 34)"); //$NON-NLS-1$
		
		assertEquals(18, this.context1.getGlobalValue("a")); //$NON-NLS-1$
		assertEquals(34, this.context2.getGlobalValue("a")); //$NON-NLS-1$
		
		this.context2.runCommand("(setf a 45)"); //$NON-NLS-1$
