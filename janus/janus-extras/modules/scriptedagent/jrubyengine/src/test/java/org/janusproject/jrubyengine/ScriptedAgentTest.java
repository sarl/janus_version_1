...
public class ScriptedAgentTest extends TestCase {
	...
	private static URL AGENT1_SCRIPT = Resources.getResource(ScriptedAgentTest.class, "agent1.rb"); //$NON-NLS-1$
	private static URL AGENT2_SCRIPT = Resources.getResource(ScriptedAgentTest.class, "agent2.rb"); //$NON-NLS-1$
	private static URL THIS_SCRIPT = Resources.getResource(ScriptedAgentTest.class, "this.rb"); //$NON-NLS-1$
	...
	public static class ScriptedTestingAgent extends RubyAgent {
