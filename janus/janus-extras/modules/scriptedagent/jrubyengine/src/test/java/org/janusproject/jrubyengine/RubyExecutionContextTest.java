 ...
 */
public class RubyExecutionContextTest extends TestCase {

	private static final String ADDITION_SCRIPT_NAME = "addition.rb"; //$NON-NLS-1$
	private static final String INTERPRETED_ADDITION_SCRIPT_NAME = "interpretedaddition.rb"; //$NON-NLS-1$
	private static final String HELLO_WORLD_SCRIPT_NAME = "HelloWorld.rb"; //$NON-NLS-1$
	
	private RubyExecutionContext interpreter;
	...
	protected void setUp() throws Exception {
		...
		this.additionScript = Resources.getResource(RubyExecutionContext.class, ADDITION_SCRIPT_NAME);
		this.scriptDirectory = FileSystem.convertURLToFile(this.additionScript).getParentFile();
		this.interpreter = new RubyExecutionContext();
	...
	public void testMakeFunctionCall() throws Exception {
		...
		assertEquals("myFunc($" + //$NON-NLS-1$
				RubyExecutionContext.TEMP_VARIABLE_PREFIX+"0,$" + //$NON-NLS-1$
				RubyExecutionContext.TEMP_VARIABLE_PREFIX+"1,$" + //$NON-NLS-1$
				RubyExecutionContext.TEMP_VARIABLE_PREFIX+"2)", //$NON-NLS-1$
				this.interpreter.makeFunctionCall("myFunc", 1, 3, "abc")); //$NON-NLS-1$ //$NON-NLS-2$
		assertEquals(1,
				this.interpreter.getScriptEngine().getContext().getAttribute(RubyExecutionContext.TEMP_VARIABLE_PREFIX+"0")); //$NON-NLS-1$
		assertEquals(3,
				this.interpreter.getScriptEngine().getContext().getAttribute(RubyExecutionContext.TEMP_VARIABLE_PREFIX+"1")); //$NON-NLS-1$
		assertEquals("abc", //$NON-NLS-1$
				this.interpreter.getScriptEngine().getContext().getAttribute(RubyExecutionContext.TEMP_VARIABLE_PREFIX+"2")); //$NON-NLS-1$

		assertEquals("myFunc($" + //$NON-NLS-1$
				RubyExecutionContext.TEMP_VARIABLE_PREFIX+"3,$" + //$NON-NLS-1$
				RubyExecutionContext.TEMP_VARIABLE_PREFIX+"4)", //$NON-NLS-1$
				this.interpreter.makeFunctionCall("myFunc", 1.5d, new BigDecimal(2))); //$NON-NLS-1$
		assertEquals(1.5d,
				this.interpreter.getScriptEngine().getContext().getAttribute(RubyExecutionContext.TEMP_VARIABLE_PREFIX+"3")); //$NON-NLS-1$
		assertEquals(new BigDecimal(2),
				this.interpreter.getScriptEngine().getContext().getAttribute(RubyExecutionContext.TEMP_VARIABLE_PREFIX+"4")); //$NON-NLS-1$
	}
	...
	public void testRunCommandString() throws Exception {
		...
		output = new StringWriter();
		this.interpreter.setStandardOutput(output);
		v = this.interpreter.runCommand("puts 7+10*2"); //$NON-NLS-1$
		assertNull(v);
