...
public class RubyExecutionContextTest extends TestCase {
	...
	private static final String MY_PRINT_SCRIPT_NAME = "Print.rb"; //$NON-NLS-1$
	private static final String METHOD_SCRIPT_NAME = "Method.rb"; //$NON-NLS-1$
	...
	public void testRunCommandString() throws Exception {
		Object v = this.interpreter.runCommand("nil == nil"); //$NON-NLS-1$
