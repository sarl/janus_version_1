 ...
 */
public interface BDIActionFactory {
	/**
	 * Get all the actions.
	 * @return a collection of actions
	 */
	public Collection<BDIAction> getActions();
	
	/**
	 * Retrieve an action
	 * @param agent is the BDIAgent calling the method
	 * @param action is the action's class
	 * @return an instanciated action
	 */
	public BDIAction getAction(BDIAgent agent, Class<? extends BDIAction> action);
}
