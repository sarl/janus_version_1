 ...
 */
public class BDIProtocolEvent
extends BDIBeliefEvent {
	/**
	 */
	private static final long serialVersionUID = 602553458336858635L;
	
	/**
	 * 
	 * @param belief
	 */
	public BDIProtocolEvent(BDIBelief belief) {
		super(belief);
	}
}
