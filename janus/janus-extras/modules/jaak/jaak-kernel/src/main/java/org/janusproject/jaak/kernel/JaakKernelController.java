 ...
 */
public interface JaakKernelController {

	/** Replies the address of the Jaak kernel.
	 * 
	 * @return the address of the Jaak kernel.
	 */
	public AgentAddress getKernelAddress();
	
	/** Return the time manager supported by the Jaak kernel.
	 * 
	 * @return the Jaak time manager.
	 */
