...
/** 
 * Prey in a wild world.
 * Prey tries to escape predators.
 * <p>
...
public class Prey extends AnimatRole {
	...
	public Status live() {
		switch(this.state) {
		case PRESENTATION:
			broadcastMessage(Terrain.class, new GameMessage(GameMessageType.I_AM_PREY));
