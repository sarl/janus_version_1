...
import org.janusproject.demos.acl.query.role.Inquirer;
 ...
 */
public class ACLAgentInquirer extends ACLAgent {
	...
	public Status activate(Object... parameters) {
		for (Object parameter : parameters) {
			if (parameter instanceof QueryInfo) {
				...
				if (providerGA!=null) {
					if(requestRole(Inquirer.class, providerGA, this.queryInfo, new FipaConversationManager(this)) != null){
	...
	private void print(String str){
		super.print("[" + this.getAddress() + "] : " + str); //$NON-NLS-1$ //$NON-NLS-2$
	}
}