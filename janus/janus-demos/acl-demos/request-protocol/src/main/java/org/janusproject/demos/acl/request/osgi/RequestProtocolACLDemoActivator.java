 ...
 */
package org.janusproject.demos.acl.request.osgi;
...
/** OSGi activator for the request protocol.
 * 
 * @author $Author: ngaud$
 * @version $FullVersion$
 ...
 */
public class RequestProtocolACLDemoActivator  implements BundleActivator, JanusApplication {
	...
	public void start(BundleContext context) throws Exception {
		...
		this.logger.info(Locale.getString(RequestProtocolACLDemoActivator.class, "ACTIVATING_ACLBASE")); //$NON-NLS-1$
	...
	public String getName() {
		return Locale.getString(RequestProtocolACLDemoActivator.class, "APPLICATION_NAME"); //$NON-NLS-1$
	}
	...
	public String getDescription() {
		return Locale.getString(RequestProtocolACLDemoActivator.class, "APPLICATION_DESCRIPTION"); //$NON-NLS-1$
	}
	/**
	 * {@inheritDoc}
	 */
