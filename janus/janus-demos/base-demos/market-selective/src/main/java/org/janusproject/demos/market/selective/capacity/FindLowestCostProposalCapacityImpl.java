...
/**
 * Atomic implementation of the capacity <code>FindLowestCostProposalCapacity</code>.
 * 
 * 
 ...
 * @see FindLowestCostProposalCapacity
 *
 */
public class FindLowestCostProposalCapacityImpl
extends CapacityImplementation
implements FindLowestCostProposalCapacity
{
	
	/**
	 */
	public FindLowestCostProposalCapacityImpl() {
