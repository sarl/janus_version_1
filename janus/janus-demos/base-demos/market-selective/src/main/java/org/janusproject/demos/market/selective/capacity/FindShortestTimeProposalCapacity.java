...
/**
 * Identify the best proposal according to the time parameter among a list of proposal
 * Identify the proposal with the shortest time in a list of proposals
 * <p>
 * <table>
 * <tr><td>Input</td><td>{@link Proposal}...</td><td>a list of proposals</td><tr>
 * <tr><td>Output</td><td>{@link Proposal}</td>
 *     <td>the proposal with the shortest time of the previous list</td></tr>
 * </table>
 * 
 * @author $Author: ngaud$
 * @version $FullVersion$
