...
/**
 * Message that contains a contract query.
 * 
 ...
 */
public class ContractQueryMessage extends ObjectMessage {
	 ...
	 */
	public ContractQueryMessage(Object contractDescription) {
		super(contractDescription);
	}
