 ...
 */
public class TransfertSignal extends Signal {
	 ...
	 * @param iga
	 */
	public TransfertSignal(Object source, AgentAddress provider, GroupAddress iga) {
		super(source, TransfertSignal.class.getName(), provider, iga);
	}
